...
class _$ProductImpl implements _Product {
  ...
  @override
  String toString() {
    return 'Product(docId: $docId, title: $title, description: $description, price: $price, isDiscount: $isDiscount, stock: $stock, discountRate: $discountRate, imageUrl: $imageUrl, timestamp: $timestamp)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, docId, title, description, price,
      isDiscount, stock, discountRate, imageUrl, timestamp);
